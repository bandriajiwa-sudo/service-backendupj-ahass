    ...
    public function run(): void
    {
        ...
        try {
            ...
            foreach ($data as $item) {
                // Generate stock conditions: 50 items critical (under 5), 25 safe (over 10)
                if ($index < 50) {
                    $stokSekarang = rand(0, 4);
                } else {
                ...
                $cat = Category::firstOrCreate(
                    ...
                    ['kode_kategori' => 'KTG-' . str_pad(Category::count() + 1, 3, '0', STR_PAD_LEFT)]
                );
                ...
                $od = SparePartOrderDetail::create([
                    ...
                    'spare_part_id' => $sp->id,
                    'jumlah_qty' => max($stokSekarang, 5) // dummy initial count
                ]);
